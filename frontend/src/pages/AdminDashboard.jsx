...
import { Search, Filter, Layers, DollarSign, Calendar, ChevronRight, FileSpreadsheet } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200 dark:border-darkBorder/40 pb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Monitor client project proposals, pipeline metrics, and update client statuses.
          </p>
        </div>
      </div>
      ...
      <div className="glass-card rounded-xl overflow-hidden border border-slate-200/50 dark:border-darkBorder/50 shadow-sm">
